  ...
  return (
    <div>
      ...
      <div className="flex mt-10 p-4">
        <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
          <div className="px-10 bg-[#FFEDCC] rounded-3xl  bg-opacity-50 py-10 w-[320px]">
            <h1 className="text-[20px] text-center laila-bold md:text-[32px] sm:text-[28px]">
              Thank you!
              <br />
              Best of Luck
              <br />
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <img src="sb.png" alt="sb" className="bg-[#92b13f] px-2  mb-2 rounded-md mt-1" width={"60%"} height={"40%"}></img>
        </div>
      </div>
    </div>
  );
